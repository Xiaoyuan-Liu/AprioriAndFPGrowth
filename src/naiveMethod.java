...
public class naiveMethod {
    ...
    naiveMethod(int min_sup,float con, int DSNo,String PathName)throws IOException {
    ...
    public void naiveMining()throws IOException{
        ArrayList<Itemset>frequentSet=frequentSubset();
        for(int i=0;i<frequentSet.size();i++){
            if(frequentSet.get(i).getCount()<min_sup)
